...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["781216386286223360"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setDescription(`<a:zmrt:781255048029667398> **Toplam Kayıtların:** \`${kayıtlar}\`
<a:zmrt:781255048029667398> **Toplam Erkek Kayıtların:** \`${erkek}\`
<a:zmrt:781255048029667398> **Toplam Kadın Kayıtların:** \`${kadın}\``)
.setFooter(`Pinkie Bella ♥ Ropenizim`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
.setDescription(`<a:zmrt:781255048029667398> **Toplam Kayıtların:** \`${kayıtlar1}\`
<a:zmrt:781255048029667398> **Toplam Erkek Kayıtların:** \`${erkek1}\`
<a:zmrt:781255048029667398> **Toplam Kadın Kayıtların:** \`${kadın1}\``)
.setFooter(`Pinkie Bella ♥ Ropenizim`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
