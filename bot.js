...
client.on("guildMemberAdd", member => {
  member.roles.add('781216659436339200'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
...
client.on("guildMemberAdd", member => {  
    const kanal = member.guild.channels.cache.find(r => r.id === "781214721621753916");
    const register = "<@&781216386286223360>"
    let user = client.users.cache.get(member.id);
    require("moment-duration-format");
      const kurulus = new Date().getTime() - user.createdAt.getTime();  
   
    var kontrol;
  if (kurulus < 1296000000) kontrol = '<a:ucgen:781254887811579974> Hesap Durumu: Güvenilir Değil <a:no:781254874071171083>'
  if (kurulus > 1296000000) kontrol = '<a:ucgen:781254887811579974> Hesap Durumu: Güvenilir Gözüküyor <a:yes:781254885114773525>'
    moment.locale("tr");
      const ropenizimlog = new Discord.MessageEmbed()
      .setAuthor(member.guild.name)
  .setDescription("**<a:meraba:781255043990159460> Sunucumuza Hoşgeldin! <@" + member + "> Seninle \`" + member.guild.memberCount + "\` Kişiyiz.\n\n<a:morzmrt:781254935949869156> Müsait Olduğunda Ses Teyit Odalarından Birine Geçip Kaydını Yaptırabilirsin. \n\n<a:gvnli:781254912272629761> <@&781216386286223360> Rolündeki Yetkililerimiz Seninle İlgilenicektir. \n\n<a:zmrt:781255048029667398> Hesabın Oluşturulma Tarihi: " + moment(member.user.createdAt).format("`YYYY DD MMMM dddd`") +  "\n\n"  + kontrol + "\n\n<a:tik:781254880428949536> Sunucumuzda İyi Vakit Geçirmen Dileğiyle Pinkie Bella & Ropenizim #EKİP.**\n")
   .setImage("https://cdn.discordapp.com/attachments/750830630748553399/781269832024457236/20201126_002541.gif")
   kanal.send(ropenizimlog)   
     kanal.send(register) 
  });
